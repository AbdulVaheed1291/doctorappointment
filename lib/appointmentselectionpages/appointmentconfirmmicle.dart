...
class Appointmentconfirmpopupmicle extends StatelessWidget {
  const Appointmentconfirmpopupmicle({super.key});
        ...
        builder: (context, state) {
          ...
          return AlertDialog(
            ...
            actions: [
              TextButton(
                onPressed: () {
                  cubit.Micleappointment(); Navigator.of(context).pushReplacement(MaterialPageRoute(
                    builder: (context) => Appointmenthistory(),
                  ));
                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                    content: Te(
                        text: "Appointment is Confirmed with Dr Micle",
                        cl: Colors.white,
                        size: 15,
